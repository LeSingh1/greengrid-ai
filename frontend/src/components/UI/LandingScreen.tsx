      ...
      <div className="relative z-10 max-w-6xl mx-auto px-8 py-14">
        ...
        >
          ...
          >
            ...
            <h1 className="font-display font-bold tracking-widest uppercase mb-1" style={{ fontSize: 32, color: 'var(--color-accent-green)', letterSpacing: '0.15em', lineHeight: 1.1, filter: 'drop-shadow(0 1px 0 #ffffff)' }}>
              GreenGrid AI
            </h1>
            ...
            <div className="mb-4">
              <span className="font-mono text-[9px] tracking-widest uppercase" style={{ color: '#00b894' }}>TECH TO TREASURE · CLIMATE READY</span>
            </div>

            <p style={{ color: 'var(--color-text-secondary)', fontSize: 12, lineHeight: 1.7 }} className="mb-6">
              Detect heat islands, green-space gaps, and transit deserts. Apply a targeted AI plan to reduce emissions and improve climate resilience for residents.
            </p>
