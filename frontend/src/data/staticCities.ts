...
export const STATIC_CITIES: CityProfile[] = [
  city('fremon', 'Fremon', 'Generated City', 37.5485, -121.9886, 12, 'Simulated future suburb', 420000, 88000, 3.5,
    ...
    [
      { name: 'North Transit Gap', lat: 37.578, lng: -122.018, zone_type_id: 'BUS_STATION', category: 'District', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      ...
      { name: 'South Emergency Gap', lat: 37.504, lng: -121.984, zone_type_id: 'HEALTH_CLINIC', category: 'District', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'Central Green Space Gap', lat: 37.556, lng: -121.965, zone_type_id: 'PARK_SMALL', category: 'District', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'West Congestion Zone', lat: 37.546, lng: -122.026, zone_type_id: 'BUS_STATION', category: 'District', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
      { name: 'Innovation District', lat: 37.565, lng: -121.946, zone_type_id: 'COM_OFFICE_PLAZA', category: 'District', data_source: 'projected', w_deg: 0.016, h_deg: 0.011 },
      { name: 'New Housing Expansion Zone', lat: 37.516, lng: -121.942, zone_type_id: 'RES_MIXED_USE', category: 'District', data_source: 'projected', w_deg: 0.018, h_deg: 0.012 },
    ]
  ),
...
function city(
  ...
  return {
    ...
    historical_snapshots: [
      ...
      { year: 2024, population: population_current, area_km2: 800, key_event: 'Current planning baseline for GreenGrid AI simulation' },
    ],
  }
}
